...
def get_ind_returns():
    ...
    """
    ind = pd.read_csv("../CPPI/Portfolio.csv", sep=';', header=0, index_col=0)/100
    ind.index = pd.to_datetime(ind.index, format="%Y%m").to_period('M')
    ind.columns = ind.columns.str.strip()
    return ind
...
def get_ind_nfirms():
    ...
    """
    ind = pd.read_csv("../CPPI/ind30_m_nfirms.csv", sep=';', header=0, index_col=0)/1
    ind.index = pd.to_datetime(ind.index, format="%Y%m").to_period('M')
    ind.columns = ind.columns.str.strip()
    return ind
...
def get_ind_size():
    ...
    """
    ind = pd.read_csv("../CPPI/ind30_m_size.csv", sep=';', header=0, index_col=0)/1
    ind.index = pd.to_datetime(ind.index, format="%Y%m").to_period('M')
    ind.columns = ind.columns.str.strip()
    return ind
